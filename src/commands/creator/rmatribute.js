...
export default {
    name: 'remove',
    description: 'Remove pontos de atributos de um usuário',
    ...
    async run({ sock, msg, args }) {
        ...
        userData[atributo] = Math.max(0, (userData[atributo] || 0) - valor)
        saveCounts()

        await sock.sendMessage(groupJid, {
            text: `✅ O atributo *${atributo}* de @${targetId.split('@')[0]} foi reduzido em *${valor}*! Valor atual: *${userData[atributo]}*`,
            mentions: [targetId]
        }, { quoted: msg })
    }
}
